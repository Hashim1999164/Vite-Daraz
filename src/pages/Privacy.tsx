    ...
    <main className="flex-grow flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-gray-500 text-sm">
          For questions or concerns, please contact us at <a href="mailto:contact@linkwizard.app" className="text-purple-600 hover:underline">contact@linkwizard.app</a>.
        </p>
      </motion.div>
    </main>
    <Footer />
