    ...
    <main className="flex-grow flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <p className="text-gray-500 text-sm">
          Want to get in touch or contribute? Visit our <a href="/contact" className="text-purple-600 hover:underline">Contact</a> page. <a href="https://github.com/linkwizard" className="text-purple-600 hover:underline" target="_blank" rel="noopener noreferrer"></a>
        </p>
      </motion.div>
    </main>
    <Footer />
