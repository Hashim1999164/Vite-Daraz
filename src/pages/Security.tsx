  ...
  <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-purple-50 to-blue-50">
    ...
    >
      ...
      <p className="text-gray-500 text-sm">
        If you discover a security issue, please report it to <a href="mailto:security@linkwizard.com" className="text-purple-600 hover:underline">security@linkwizard.com</a>.
      </p>
    </motion.div>
  </div>
);
